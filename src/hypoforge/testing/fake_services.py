"""Fake (deterministic) service container for tests.

Provides stub agents that produce fixed data without calling any LLM,
so integration and unit tests can exercise the coordinator logic
